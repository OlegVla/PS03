...
divans = driver.find_elements(By.CLASS_NAME, 'Ud0k')
...
for divan in divans:
   ...
   # Находим названия вакансии
     #title = vacancy.find_element(By.CSS_SELECTOR, 'span.vacancy-name--div.lsooF').text
     # Находим названия компаний
     company = divans.find_element(By.CSS_SELECTOR, 'div.lsooF').text
     # Находим зарплаты
     salary = divans.find_element(By.CSS_SELECTOR, 'div.pY3d2').text
     # Находим ссылку с помощью атрибута 'href'
     link = divans.find_element(By.CSS_SELECTOR, 'a').get_attribute('href')
...
parsed_data.append([company, salary, link])
...
# Создаём первый ряд
    writer.writerow([ 'название компании', 'зарплата', 'ссылка на вакансию'])
